			...
			<div class="card-header bg-light">
				<div class="row">
					...
					<div class="col-4 text-right">
						종합 평가&nbsp;<span style="color: red;"><%= evaluation.getTotalEvaluation() %></span>
					</div>
				</div>
			</div>
			<div class="card-body">
				...
				<div class="row">
					<div class="col-9 text-left">
						받은성적 <span style="color: red;"><%= evaluation.getGrade() %></span> &nbsp; 강의수준 <span
							style="color: red;"><%= evaluation.getLectureLevel() %></span>&nbsp; 친절도 <span style="color: red;"><%= evaluation.getKindness() %></span>
